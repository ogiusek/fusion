...
class UrlTest extends \PHPUnit\Framework\TestCase {
  ...
  // function test_init_without_slash() {
  //   $url = new Url("test?a=1");
  //   $this->assertTrue(true);
  // }

  // function test_init_error_throws() {
  ...
  // function test_get_search_param() {
  //   $url = new Url("/test?a=1");
  ...
  // function test_matches_with_wrong_input(){
  //   $url = new Url("/account/:id");
  ...
  // function test_get_vars_error_throws() {
  //   $url = new Url("/account/:id");
